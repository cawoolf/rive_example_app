...
import 'package:rive_example_app/theme.dart';
...
class _RiveAppHomeState extends State<RiveAppHome>
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          _onBoardingIcon(),
          _hamburgerMenuIcon(),
          if (_showOnBoarding) _displayOnBoarding(context),
          _whiteUnderLay(),
          // White underlay behind the bottom tab bar
        ],
      ),
      bottomNavigationBar: _bottomCustomTabBar(),
    );
  }

  RepaintBoundary _bottomCustomTabBar() {
  ...
  IgnorePointer _whiteUnderLay() {
    return // White underlay behind the bottom tab bar
        IgnorePointer(
      ignoring: true,
      child: Align(
  ...
  RepaintBoundary _sideMenuContent() {
    return RepaintBoundary(
      child: AnimatedBuilder(
  ...
  Positioned _roundedBackground() =>
      Positioned(child: Container(color: RiveAppTheme.background2));

  RepaintBoundary _mainBodyContent() {
    return RepaintBoundary(
      child: AnimatedBuilder(
  ...
  RepaintBoundary _hamburgerMenuIcon() {
    return RepaintBoundary(
      child: AnimatedBuilder(
        animation: _sidebarAnim,
        builder: (context, child) {
  ...
  AnimatedBuilder _onBoardingIcon() {
    return AnimatedBuilder(
      ...
      ), // Upper right hand person Icon that displays the onBoarding.
    );
  }

  RepaintBoundary _displayOnBoarding(BuildContext context) {
    return RepaintBoundary(
      child: AnimatedBuilder(
